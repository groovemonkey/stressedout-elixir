defmodule StressedoutWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StressedoutWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StressedoutWeb.Gettext, "errors", msg, opts)
    end
  end
